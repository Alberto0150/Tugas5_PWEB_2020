<?php
    ...
    $db = mysqli_connect("localhost", "id15323932_admin321", "3?=p{<5?fXsA3D49", "id15323932_guest_book");
    if( !$db ){
    ...
    function dbclose() {
        mysqli_close(mysqli_connect("localhost", "id15323932_admin321", "3?=p{<5?fXsA3D49", "guest_book"));
    }
?>